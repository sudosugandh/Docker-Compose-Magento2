 ...
 *
 * This file includes the referenced bin path (../laminas/laminas-view/bin/templatemap_generator.php)
...
if (PHP_VERSION_ID < 80000) {
    ...
    if (function_exists('stream_wrapper_register') && stream_wrapper_register('composer-bin-proxy', 'Composer\BinProxyWrapper')) {
        include("composer-bin-proxy://" . __DIR__ . '/..'.'/laminas/laminas-view/bin/templatemap_generator.php');
        exit(0);
    }
}

include __DIR__ . '/..'.'/laminas/laminas-view/bin/templatemap_generator.php';
